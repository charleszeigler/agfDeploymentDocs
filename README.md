...
- Apex, tests, Flows, prompt templates, Custom Lightning Types, LWC CLT renderers, objects, fields, permission sets, and credentials
...
- Clean-target validation for each customer package
