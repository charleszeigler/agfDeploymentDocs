...
5. Run a live-action preview with a test record or a customer-approved record.
...
4. Confirm the customer website or Experience Builder site uses the target-org snippet or Embedded Messaging component.
